...
int Read_ADC (unsigned char Channel)
{
	ADMUX = 0x40 | Channel ;  // Select the ADC Channel and REFS0 = 1, for AVCC with external capacitor at AREF pin.
	...
	return ADCW;              // Return the upper 8 bits in ADC Data Register.
}
